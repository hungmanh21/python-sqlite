...
>
> **Time:** ~40 minutes. **Prerequisite:** [chapter 04](04-buffer-pool.md). The arithmetic in §5.3 is the centre of the chapter.
...
The rightmost-split special case (§5.7) isn't in `roadmap.md` or `implementation.md`. **Add it to week 2 session 6**, right after the basic split works. It's five lines, it's the highest value-per-line change available to you, and it produces a measurable before/after number for week 8.
