...
>
> **Time:** ~50 minutes. **Prerequisite:** [chapter 05](05-b-trees.md) for the *why*; [chapter 02](02-slotted-page.md) for the page layout this all sits on.
>
...
`implementation.md` week 2 session 2 has you build this against a **hand-built page** before insert works. Do it that way. Testing search against a fixture you constructed by hand means a failure is unambiguously in search, not in insert.
...
**End of the written chapters.** Weeks 3–8 (SQL frontend, indexes and planning, transactions and recovery, concurrency, joins and aggregation, presentation) follow the same format and aren't written yet — see [README.md](README.md).
